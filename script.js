document
  ...
  .addEventListener("submit", async function (e) {
    ...
    const googleScriptURL = "https://script.google.com/macros/s/AKfycbygWzAoXEWYMlz-PUuD3ADWasdOwGyOJblgh_dEqv9LSqJDUOSjY4tulnv64qqzFgh7dw/exec"; // 👈 ใส่ Apps Script URL ที่นี่
